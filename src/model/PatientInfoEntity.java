...
public class PatientInfoEntity implements Serializable {
    ...
    private List<PatientDiagnosEntity> patientsDiagnos;
    ...
    public List<PatientDiagnosEntity> getPatientsDiagnosis() {
       // logger.debug(patientsDiagnosis);
        return patientsDiagnos;
    }

    public void setPatientsDiagnosis(List<PatientDiagnosEntity> list) {
       // logger.debug(patientsDiagnos);
        patientsDiagnos = list;
    }

...
public class Queries {
	public static final String GET_PATIENT_BY_ID =
            "SELECT * FROM hospital.patient where ID_Patient = ?";

    public static final String GET_DIAGNOSIS_INFO_BY_ID =
            "SELECT * FROM hospital.diagnos_info where ID_Diagnosis = ?";

    public static final String GET_ALL_DIAGNOSIS =
            "SELECT * FROM hospital.diagnos_info";

    public static final String GET_RECIPE_INFO_BY_ID =
            "SELECT * FROM hospital.recipe where ID_Prescription = ?";

    public static final String GET_ALL_RECIPE =
            "SELECT * FROM hospital.recipe";
